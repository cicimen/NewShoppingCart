...
{
    [Authorize]
    public class AccountController : ShoppingCartControllerBase
    {
        ...
        public async Task<ActionResult> ExternalLoginCallback(string returnUrl)
        {
            ...
            else
            {
                ...
                Claim emailClaim = claimsIdentity.Claims.SingleOrDefault(c => c.Type.StartsWith("urn:facebook:email"));
                string email = "";
                if (emailClaim != null)
                {
        ...
        {
            Carts.MigrateCart(userName,this.HttpContext);
            //Session[Carts.CartSessionKey] = userName;
        }
